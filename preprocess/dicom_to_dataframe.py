# -*- coding: utf-8 -*-
# @Time    : 2020/3/30 17:11
# @Author  : zhao pengfei
# @Email   : zsonghuan@gmail.com
# @File    : dicom_to_dataframe.py
import sys
import argparse
import functools
import pickle
...
if __name__ == '__main__':
    print(sys.argv)
    #--input /home/amax/xiangxi-ubuntu/zpf/small_data/small_data.csv --output./cache/train_raw.pkl - -imgdir/home/amax/xiangxi - ubuntu /zpf/small_data/train_images
    main()